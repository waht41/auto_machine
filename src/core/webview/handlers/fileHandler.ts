 ...
 * 打开图像
 */
export async function handleOpenImage(instance: ClineProvider, message: WebviewMessage) {
 ...
 * 打开文件
 */
export async function handleOpenFile(instance: ClineProvider, message: WebviewMessage) {
 ...
 * 打开提及
 */
export async function handleOpenMention(instance: ClineProvider, message: WebviewMessage) {
