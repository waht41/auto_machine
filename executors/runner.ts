...
export class CommandRunner {
	...
	async runCommand(command: Command, context: ExecutionContext): Promise<unknown> {
	...
	private async runMiddlewares(command: Command, context: ExecutionContext): Promise<unknown> {
		// 如果没有中间件，直接执行命令
